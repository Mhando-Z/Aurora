...
//                     className="flex items-center gap-2 rounded-xl p-1.5 pr-2 transition hover:bg-black/[0.04]"
...
//                           <Link
//                             href="/account"
//                             className="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-black/65 transition hover:bg-black/[0.04] hover:text-black"
//                           >
...
//                             <button
//                               type="submit"
//                               className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left text-sm font-medium text-black/65 transition hover:bg-black/[0.04] hover:text-black"
//                             >
...
//                 <Link
//                   href="/login"
//                   className="flex items-center gap-2 rounded-xl px-4 py-2.5 text-sm font-semibold text-black/65 transition hover:bg-black/[0.04] hover:text-black"
//                 >
...
//                   <Link
//                     href="/register"
//                     className="flex items-center gap-2 rounded-xl bg-black px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-black/85"
//                   >
...
//               <Link
//                 href="/cart"
//                 className="relative flex h-10 w-10 items-center justify-center rounded-xl text-black/70 transition hover:bg-black/5"
...
//               className="flex h-10 w-10 items-center justify-center rounded-xl text-black transition hover:bg-black/5"
...
//                         <button
//                           type="submit"
//                           className="flex w-full items-center justify-center gap-2 rounded-xl border border-black/10 px-4 py-3 text-sm font-semibold text-black transition hover:bg-black/[0.04]"
//                         >
//                           <LogOut className="h-4 w-4" />
//                           Logout
//                         </button>
...
//                         <Link
//                           href="/login"
//                           className="flex items-center justify-center gap-2 rounded-xl border border-black/10 px-4 py-3 text-sm font-semibold text-black"
//                         >
//                           <LogIn className="h-4 w-4" />
//                           Login
//                         </Link>
...
//                         <Link
//                           href="/register"
//                           className="flex items-center justify-center gap-2 rounded-xl bg-black px-4 py-3 text-sm font-semibold text-white"
//                         >
//                           <UserPlus className="h-4 w-4" />
//                           Register
//                         </Link>
