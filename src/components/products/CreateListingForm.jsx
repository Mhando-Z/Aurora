    ...
    >
      ...
      >
        ...
        <motion.button
          ...
          className="ml-auto inline-flex min-w-48 items-center justify-center gap-2 rounded-2xl bg-black px-6 py-2 font-semibold text-white transition-opacity disabled:opacity-50"
        >
          {submitting ? (
            <>
              <Loader2 className="h-4 w-4 animate-spin" /> Publishing…
